...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-01 17:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ffe733a6-74c1-4c19-b70d-5bf9ce496228.git
$ cd ffe733a6-74c1-4c19-b70d-5bf9ce496228
```
